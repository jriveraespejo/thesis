...
"
save_code = file.path(getwd(), 'results', "FOLV_center.stan")
...
#            output_basename = 'FOLV_center',
#            chains=3, parallel_chains=3, init=0, adapt_delta=0.99 )
# t1 = proc.time()
# 
# elapsed = (t1-t0)
# save(elapsed, file=file.path(getwd(), 'results', 'FOLV_center_time.RData'))
#
# comments:
# we have issues with divergent transition (around 400 divergences), 
# and effective sample sizes are poor.
...
transformed parameters{
    ...
    for(j in 1:J){
      m_mult[j,] = rep_row_vector( a + b_G[ GE[j] ] + b_A*(AG[j] - min_AG) +
                                b_E[ ED[j] ] + b_S[ SP[j] ] + b_Di[ DI[j] ] +
                                b_Xpu[ XPpu[j] ] + b_Xpr[ XPpr[j] ] , D);
    }
...
"
save_code = file.path(getwd(), 'results', "FOLV_noncenter.stan")
writeLines(mcmc_code, con=save_code)
...
# t0 = proc.time()
# mod$sample(data=data_app, output_dir=file.path(getwd(),'results'),
#            output_basename = 'FOLV_noncenter',
#            chains=3, parallel_chains=3, init=0, adapt_delta=0.99 )
# t1 = proc.time()
# 
# elapsed = (t1-t0)
# save(elapsed, file=file.path(getwd(), 'results', 'FOLV_noncenter_time.RData'))
#
# comments:
# SURPRISE, SURPISE!!!, this model still have 33% of divergent transitions
...
fit_files = file.path(getwd(), 'results', paste0('FOLV_center-',1:3,'.csv'))
...
save( result, file=file.path(file_save, 'FOLV_CE_stat.RData' ) )

# posterior samples
set.seed(45589)
result = extract.samples( stan_model_c )
save( result, file=file.path(file_save, 'FOLV_CE_post.RData' ) )


# WAIC and PSIS
result = WAIC(stan_model_c, pointwise=TRUE)
save( result, file=file.path(file_save, 'FOLV_CE_WAIC.RData' ) )


fit_files = file.path(getwd(), 'results', paste0('FOLV_center-',1,'.csv'))
stan_model_c = rstan::read_stan_csv(fit_files)
result = PSIS(stan_model_c, pointwise=TRUE)
save( result, file=file.path(file_save, 'FOLV_CE_PSIS_OneChain.RData' ) )
...
fit_files = file.path(getwd(), 'results', paste0('FOLV_noncenter-',1:3,'.csv'))
...
save( result, file=file.path(file_save, 'FOLV_NC_stat.RData' ) )

# posterior samples
set.seed(45589)
result = extract.samples( stan_model_nc )
save( result, file=file.path(file_save, 'FOLV_NC_post.RData' ) )


# WAIC and PSIS
result = WAIC(stan_model_nc, pointwise=TRUE)
save( result, file=file.path(file_save, 'FOLV_NC_WAIC.RData' ) )


fit_files = file.path(getwd(), 'results', paste0('FOLV_noncenter-',1,'.csv'))
stan_model_nc = rstan::read_stan_csv(fit_files)
result = PSIS(stan_model_nc, pointwise=TRUE)
save( result, file=file.path(file_save, 'FOLV_NC_PSIS_OneChain.RData' ) )
...
png(file.path(file_save, 'FOLV_CE_mb.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('m_b[',1:5,']')
tri_plot(stan_model_c, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_CE_sb.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('s_b[',1:5,']')
tri_plot(stan_model_c, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_CE_bk_1_5.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('b_k[',1:5,']')
tri_plot(stan_model_c, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_CE_bk_6_10.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('b_k[',6:10,']')
tri_plot(stan_model_c, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_CE_bk_11_15.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('b_k[',11:15,']')
tri_plot(stan_model_c, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_CE_bk_16_20.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('b_k[',16:20,']')
tri_plot(stan_model_c, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_CE_bk_21_25.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('b_k[',21:25,']')
tri_plot(stan_model_c, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_CE_reg_1.png'), 
    units='cm', width=30, height=30, res=100)
idx = c('a', paste0('b_G[',1:2,']'),'b_A')
tri_plot(stan_model_c, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_CE_reg_2.png'), 
    units='cm', width=30, height=30, res=100)
idx = c(paste0('b_E[',1:3,']'))
tri_plot(stan_model_c, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_CE_reg_3.png'), 
    units='cm', width=30, height=30, res=100)
idx = c(paste0('b_S[',1:3,']'))
tri_plot(stan_model_c, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_CE_reg_4.png'), 
    units='cm', width=30, height=30, res=100)
idx = c(paste0('b_Xpu[',1:4,']'))
tri_plot(stan_model_c, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_CE_reg_5.png'), 
    units='cm', width=30, height=30, res=100)
idx = c(paste0('b_Xpr[',1:4,']'))
tri_plot(stan_model_c, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_CE_reg_6.png'), 
    units='cm', width=30, height=30, res=100)
idx = c(paste0('b_Di[',1:4,']'))
tri_plot(stan_model_c, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_CE_rho.png'), 
    units='cm', width=30, height=30, res=100)
idx = c('Rho_theta_sub[1,2]','Rho_theta_sub[1,3]','Rho_theta_sub[2,3]')
tri_plot(stan_model_c, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_CE_theta1.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('theta_sub[',1:5,',1]')
tri_plot(stan_model_c, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_CE_theta2.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('theta_sub[',1:5,',2]')
tri_plot(stan_model_c, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_CE_theta3.png'), 
    units='cm', width=30, height=30, res=100)
...
png(file.path(file_save, 'FOLV_NC_mb.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('m_b[',1:5,']')
tri_plot(stan_model_nc, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_NC_sb.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('s_b[',1:5,']')
tri_plot(stan_model_nc, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_NC_bk_1_5.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('b_k[',1:5,']')
tri_plot(stan_model_nc, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_NC_bk_6_10.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('b_k[',6:10,']')
tri_plot(stan_model_nc, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_NC_bk_11_15.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('b_k[',11:15,']')
tri_plot(stan_model_nc, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_NC_bk_16_20.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('b_k[',16:20,']')
tri_plot(stan_model_nc, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_NC_bk_21_25.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('b_k[',21:25,']')
tri_plot(stan_model_nc, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_NC_reg_1.png'), 
    units='cm', width=30, height=30, res=100)
idx = c('a', paste0('b_G[',1:2,']'),'b_A')
tri_plot(stan_model_nc, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_NC_reg_2.png'), 
    units='cm', width=30, height=30, res=100)
idx = c(paste0('b_E[',1:3,']'))
tri_plot(stan_model_nc, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_NC_reg_3.png'), 
    units='cm', width=30, height=30, res=100)
idx = c(paste0('b_S[',1:3,']'))
tri_plot(stan_model_nc, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_NC_reg_4.png'), 
    units='cm', width=30, height=30, res=100)
idx = c(paste0('b_Xpu[',1:4,']'))
tri_plot(stan_model_nc, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_NC_reg_5.png'), 
    units='cm', width=30, height=30, res=100)
idx = c(paste0('b_Xpr[',1:4,']'))
tri_plot(stan_model_nc, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_NC_reg_6.png'), 
    units='cm', width=30, height=30, res=100)
idx = c(paste0('b_Di[',1:4,']'))
tri_plot(stan_model_nc, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_NC_rho.png'), 
    units='cm', width=30, height=30, res=100)
idx = c('Rho_theta_sub[1,2]','Rho_theta_sub[1,3]','Rho_theta_sub[2,3]')
tri_plot(stan_model_nc, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_NC_theta1.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('theta_sub[',1:5,',1]')
tri_plot(stan_model_nc, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_NC_theta2.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('theta_sub[',1:5,',2]')
tri_plot(stan_model_nc, pars=idx)
dev.off()

png(file.path(file_save, 'FOLV_NC_theta3.png'), 
    units='cm', width=30, height=30, res=100)
idx = paste0('theta_sub[',1:5,',3]')
tri_plot(stan_model_nc, pars=idx)
dev.off()
...
# load( file.path(getwd(), 'tables', 'FOLV_CE_stat.RData') )
# result_CE = result
# result_CE$parameter = row.names(result_CE)
# 
# load( file.path(getwd(), 'tables', 'FOLV_NC_stat.RData') )
# result_NC = result
# result_NC$parameter = row.names(result_NC)
# 
# stan_result = merge(result_CE, result_NC, by='parameter', all.x=T, all.y=F)
# save( stan_result, file=file.path(file_save, 'FOLV_stat.RData' ) )
# rm(list=c('result','result_CE','result_NC'))

load( file.path(file_save, 'FOLV_stat.RData' ) )
...
### items  and texts ####
png(file.path(file_save, 'FOLV_stat_mb.png'), 
    units='cm', width=30, height=12, res=100)
plot_stat_both(stat_table=stat_table, par_int=paste0('m_b[',1:5,']'))
dev.off()

png(file.path(file_save, 'FOLV_stat_sb.png'), 
    units='cm', width=30, height=12, res=100)
plot_stat_both(stat_table=stat_table, par_int=paste0('m_b[',1:5,']'))
dev.off()

png(file.path(file_save, 'FOLV_stat_bk.png'), 
    units='cm', width=30, height=12, res=100)
...
png(file.path(file_save, 'FOLV_stat_theta_sub.png'), 
    units='cm', width=30, height=12, res=100)
...
### items and texts ####
png(file.path(file_save, 'FOLV_recovery_texts.png'), 
    units='cm', width=30, height=12, res=100)
par(mfrow=c(1, 2))
...
png(file.path(file_save, 'FOLV_recovery_items.png'), 
    units='cm', width=30, height=12, res=100)
par(mfrow=c(1, 1))
...
png(file.path(file_save, 'FOLV_recovery_reg1.png'), 
...
png(file.path(file_save, 'FOLV_recovery_reg2.png'), 
    units='cm', width=15, height=12, res=100)
par(mfrow=c(1, 1))
...
png(file.path(file_save, 'FOLV_recovery_reg3.png'), 
    units='cm', width=15, height=12, res=100)
par(mfrow=c(1, 1))
...
png(file.path(file_save, 'FOLV_recovery_reg4.png'), 
    units='cm', width=15, height=12, res=100)
par(mfrow=c(1, 1))
...
png(file.path(file_save, 'FOLV_recovery_reg5.png'), 
    units='cm', width=15, height=12, res=100)
par(mfrow=c(1, 1))
...
png(file.path(file_save, 'FOLV_recovery_reg6.png'), 
    units='cm', width=15, height=12, res=100)
par(mfrow=c(1, 1))
...
png(file.path(file_save, 'FOLV_recovery_reg7.png'), 
    units='cm', width=15, height=12, res=100)
par(mfrow=c(1, 1))
...
png(file.path(file_save, 'FOLV_recovery_rho.png'), 
...
png(file.path(file_save, 'FOLV_recovery_ability1.png'), 
...
png(file.path(file_save, 'FOLV_recovery_ability2.png'), 
    units='cm', width=30, height=15, res=100)
par(mfrow=c(1, 1), mar=c(8,4.1,4.1,2.1))
...
png(file.path(file_save, 'FOLV_recovery_ability3.png'), 
    units='cm', width=30, height=15, res=100)
par(mfrow=c(1, 1), mar=c(8,4.1,4.1,2.1))
...
# 
# # centered
# load( file.path(file_save, 'FOLV_CE_post.RData' ) )
# contrast_CE = contrast_stat(results_object=stan_result,
#                             post=result,
#                             contr_pars=c('b_G','b_E','b_S','b_Xpu','b_Xpr','b_Di'))
# save( contrast_CE, file=file.path(file_save, 'FOLV_CE_contrast.RData' ) )
# 
# # non-centered
# load( file.path(file_save, 'FOLV_NC_post.RData' ) )
# contrast_NC = contrast_stat(results_object=stan_result,
#                             post=result,
#                             contr_pars=c('b_G','b_E','b_S','b_Xpu','b_Xpr','b_Di'))
# save( contrast_NC, file=file.path(file_save, 'FOLV_NC_contrast.RData' ) )
# 
# # merge
# contrast_res = merge(contrast_CE, contrast_NC, by='parameter', all.x=T)
# save( contrast_res, file=file.path(file_save, 'FOLV_contrasts.RData' ) )

load(file.path(file_save, 'FOLV_NC_contrast.RData' ))
# str(contrast_res)
...
# plot
png(file.path(file_save, 'FOLV_recovery_contrast.png'), 
    units='cm', width=30, height=15, res=100)
...
# load
file_save = file.path(getwd(), 'tables')
load( file.path(file_save, 'FOLV_CE_WAIC.RData' ) )
WAIC_CE_res = result

load( file.path(file_save, 'FOLV_CE_PSIS_OneChain.RData' ) )
PSIS_CE_res = result
...
png(file.path(file_save, 'FOLV_CE_outlier.png'), 
    units='cm', width=30, height=15, res=100)
...
# load
file_save = file.path(getwd(), 'tables')
load( file.path(file_save, 'FOLV_NC_WAIC.RData' ) )
WAIC_NC_res = result

load( file.path(file_save, 'FOLV_NC_PSIS_OneChain.RData' ) )
PSIS_NC_res = result
...
png(file.path(file_save, 'FOLV_NC_outlier.png'), 
    units='cm', width=30, height=15, res=100)
...
#### ICC ####
png(file.path(file_save, 'FOLV_CE_ICC_posterior.png'), 
...
#### IIF ####
png(file.path(file_save, 'FOLV_CE_IIF_posterior.png'), 
    units='cm', width=55, height=80, res=100)
...
# save(ds_prob_post, file=file.path(file_save, 'FOLV_CE_prob_post.RData'))
# 
# ds_out_post = sim_hit_rate(d_true=data_app, d_sim=result, prob=F)
# save(ds_out_post, file=file.path(file_save, 'FOLV_CE_out_post.RData'))
# # str(post_sim)


# load sim rates
file_save = file.path(getwd(), 'tables')
load( file.path(file_save, 'FOLV_CE_prob_post.RData') )
load( file.path(file_save, 'FOLV_CE_out_post.RData') )
...
# plot
png(file.path(file_save, 'FOLV_CE_HitRate_ind.png'), 
...
png(file.path(file_save, 'FOLV_CE_HitRate_var.png'), 
...
# plot
png(file.path(file_save, 'FOLV_CE_HitRate_items.png'), 
    units='cm', width=30, height=25, res=100)
...
# plot
png(file.path(file_save, 'FOLV_CE_HitRate_text.png'), 
    units='cm', width=30, height=25, res=100)
...
# plot
png(file.path(file_save, 'FOLV_CE_HitRate_dim.png'), 
    units='cm', width=30, height=25, res=100)
...
# ICC
png(file.path(file_save, 'FOLV_NC_ICC_posterior.png'), 
    units='cm', width=55, height=80, res=100)
...
# IIF
png(file.path(file_save, 'FOLV_NC_IIF_posterior.png'), 
    units='cm', width=55, height=80, res=100)
...
# # calculations
# ds_prob_post = sim_hit_rate(d_true=data_app, d_sim=result, prob=T)
# save(ds_prob_post, file=file.path(file_save, 'FOLV_NC_prob_post.RData'))
# 
# ds_out_post = sim_hit_rate(d_true=data_app, d_sim=result, prob=F)
# save(ds_out_post, file=file.path(file_save, 'FOLV_NC_out_post.RData'))
# # str(post_sim)


# load sim rates
file_save = file.path(getwd(), 'tables')
load( file.path(file_save, 'FOLV_NC_prob_post.RData') )
load( file.path(file_save, 'FOLV_NC_out_post.RData') )
...
# plot
png(file.path(file_save, 'FOLV_NC_HitRate_ind.png'), 
    units='cm', width=30, height=25, res=100)
...
png(file.path(file_save, 'FOLV_NC_HitRate_var.png'), 
    units='cm', width=30, height=45, res=100)
...
# plot
png(file.path(file_save, 'FOLV_NC_HitRate_items.png'), 
    units='cm', width=30, height=25, res=100)
...
# plot
png(file.path(file_save, 'FOLV_NC_HitRate_text.png'), 
    units='cm', width=30, height=25, res=100)
...
# plot
png(file.path(file_save, 'FOLV_NC_HitRate_dim.png'), 
    units='cm', width=30, height=25, res=100)
