...
\noindent Finally, it is important to mention, that the computational implementation of the method will be developed in {\color{red} \texttt{R} \citep{R2015} and \texttt{WinBUGS} \citep{Lunn_et_al_2000}}.
