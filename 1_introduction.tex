...
This research will have two main goals. First, to describe the method, estimation procedures, and advantages of the Generalized Linear Latent and Mixed Modeling framework (GLLAMM, \citealp{Rabe_et_al_2004a, Rabe_et_al_2004b, Skrondal_et_al_2004, Rabe_et_al_2012}). Second, to test the real implications of the method, in a data composed of large repeated Teacher's standardized educational assessments from Peru. \\
...
\noindent In this sense, the researcher believes the master's thesis contributes to the literature in two aspects: 
...
\noindent Finally, it is important to mention, that the computational implementation of the methods will be developed in {\color{red} \texttt{R} \citep{R2015} and \texttt{WinBUGS} \citep{Lunn_et_al_2000}}.
