...
%
\noindent \textbf{Keywords:} Bayesian modeling, MCMC, HMC, IRT, GLLAMM, centered parametrization, non-centered parametrization. 
%
%
%--------------------------------------------------------------------------
% ----------------------- table of contents -------------------------------
