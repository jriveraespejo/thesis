...
\begin{table}[H]
	...
	\begin{tabular}{rlllrrrr}		
		...
		\hline
		%
		12 & NCP & \footnotesize{Intercept} & $\Gamma_{0}$ &   10 & 0.089 & 0.065 & 0.083 \\ 
...
\begin{table}[H]
	...
	\begin{tabular}{rlllrrrr}		
		...
		\hline
		%
		12 & NCP & \footnotesize{Intercept} & $\Gamma_{0}$ &   10 & 0.11 & 0.12 & 0.16 \\ 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{FOLV_NC_J100_Ndata4_HitRate_items}
	%
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{FOLV_NC_J100_Ndata4_HitRate_dims}
	%
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{FOLV_NC_J100_Ndata4_HitRate_texts}
	%
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{SOLV_NC_J100_Ndata4_HitRate_ind}
	%
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\linewidth]{SOLV_NC_J100_Ndata4_HitRate_var}
	%
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{SOLV_NC_J100_Ndata4_HitRate_items}
	%
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{SOLV_NC_J100_Ndata4_HitRate_dims}
	%
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{SOLV_NC_J100_Ndata4_HitRate_texts}
	%
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\linewidth]{SOLV_NC_J100_Ndata4_ICC}
	%
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\linewidth]{SOLV_NC_J100_Ndata4_IIF}
	%
...
\subsection{Parametrization performance} \label{app_c5:noncenter}

%
\begin{figure}[H]
	\centering
	\includegraphics[width=1\linewidth]{SOLV_CE_bk_1_5}
	%
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\linewidth]{SOLV_NC_bk_1_5}
	%
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\linewidth]{SOLV_stat_bk}
	%
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{SOLV_CE_HitRate_ind}
	%
...
\begin{figure}[H]
	\centering
	\begin{subfigure}
		\includegraphics[width=0.9\linewidth]{SOLV_recovery_items}
	\end{subfigure}
	%
	\begin{subfigure}
		\includegraphics[width=0.87\linewidth]{SOLV_recovery_texts}
	\end{subfigure}
	%
